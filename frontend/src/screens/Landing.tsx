...
export const Landing = () => {
  ...
  return (
    <div className="relative min-h-screen text-neutral-900 dark:text-zinc-100 flex flex-col font-sans selection:bg-emerald-500/30 overflow-x-hidden transition-colors duration-300">
      ...
      <main className="relative flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16 z-10 overflow-y-auto py-4 sm:py-6">
        ...
        <div className="flex-1 w-full hidden md:flex justify-center lg:justify-end items-center">
          <div className="group relative w-full max-w-[380px] lg:max-w-[460px] xl:max-w-[500px] transition-all duration-500 ease-out hover:scale-[1.03] mix-blend-normal dark:mix-blend-plus-lighter lg:dark:mix-blend-normal">

            <div className="pointer-events-none select-none ring-1 ring-neutral-200 dark:ring-white/10 group-hover:ring-[4px] group-hover:ring-emerald-500/60 dark:group-hover:ring-emerald-400/80 group-hover:shadow-[0_0_80px_rgba(16,185,129,0.2)] dark:group-hover:shadow-[0_0_100px_rgba(52,211,153,0.15)] transition-all duration-500 rounded-2xl overflow-hidden bg-white dark:bg-black/20 relative z-10">
              <ChessBoard
                board={board}
                socket={{} as WebSocket}
                myColor="white"
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-white/90 via-white/20 dark:from-[#0a0a0a]/80 dark:via-[#0a0a0a]/20 to-transparent pointer-events-none" />
            </div>
