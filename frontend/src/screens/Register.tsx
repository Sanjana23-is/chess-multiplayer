...
export const Register = () => {
    ...
    return (
        <div className="relative min-h-screen w-full text-neutral-900 dark:text-zinc-100 overflow-hidden flex items-center justify-center font-sans tracking-wide transition-colors duration-300">
            ...
            <div className="dark:hidden absolute bottom-[-10%] left-[-10%] w-[60%] h-[70%] rounded-full bg-gradient-to-r from-cyan-300 to-emerald-300 opacity-20 blur-[100px] pointer-events-none mix-blend-multiply" />
            <div className="dark:hidden absolute top-[10%] left-[-5%] w-[40%] h-[50%] rounded-full bg-gradient-to-r from-indigo-300 to-purple-300 opacity-20 blur-[100px] pointer-events-none mix-blend-multiply" />

            {/* Abstract Background Blobs - Dark Mode */}
            <div className="hidden dark:block absolute bottom-[-10%] left-[-10%] w-[60%] h-[70%] rounded-full bg-gradient-to-r from-emerald-900 to-cyan-900 opacity-[0.15] blur-[100px] pointer-events-none" />
            ...
            <div className="relative z-10 w-full max-w-[440px] mx-4 p-8 sm:p-10 bg-white/50 dark:bg-black/40 shadow-[0_8px_32px_rgba(0,0,0,0.06)] dark:shadow-2xl rounded-[32px] border border-white/60 dark:border-white/10 backdrop-blur-xl dark:backdrop-blur-xl transition-all duration-300">
                ...
                <p className="text-[14px] font-medium text-neutral-500 dark:text-zinc-400 text-center mb-8 transition-colors">
                    Create your account and climb the ranks
                </p>
                ...
                <div className="mt-8 text-center flex flex-col items-center gap-3">
                    <Link to="/login" className="text-[12px] font-bold text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 transition-colors">
